...
public class ThumbnailLambda {
     ...
     * @param imageKey 스토리지에 저장된 이미지의 key값입니다. ex) image/{UUID}.png
     * @return 썸네일로 변환된 이미지의 key값입니다. 기본적으로 thumbnail/{key} 형식을 가집니다.
     */
    public String generateThumbnail(String imageKey) {
        ...
        try {
            ...
            throw new ThumbnailLambdaException("썸네일 생성 람다 함수 요청에 실패했습니다!", ex);
        }
    }
}
